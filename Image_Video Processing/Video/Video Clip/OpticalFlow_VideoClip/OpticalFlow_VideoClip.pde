...
////This sketch requires the PixelFlow and video Processing libraries
 ...
 */
 ...
 ///This sketch only works in Processing 3
...
import processing.video.Movie;
  ...
  public void setup() {
    ...
    opticalflow.param.blur_flow           = 1;
    opticalflow.param.blur_input          =20;
    opticalflow.param.temporal_smoothing  = 0.001f;
    opticalflow.param.flow_scale          = 30;
    opticalflow.param.threshold           = 0.05f; // flow vector length threshold
